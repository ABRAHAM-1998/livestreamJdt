...
var B = function() {
  ...
  return t2.prototype.getToken = function() {
    ...
    return this.forceRefresh = false, this.auth ? this.auth.getToken(n2).then(function(n3) {
      return t3.N !== e ? (N2("FirebaseCredentialsProvider", "getToken aborted due to token change."), t3.getToken()) : n3 ? (k2("string" == typeof n3.accessToken), new z2(n3.accessToken, t3.currentUser)) : null;
    ...
    return k2(null === t3 || "string" == typeof t3), new j(t3);
  }, t2;
}();
var Q2 = function() {
  function t2(t3, e) {
...
var W2 = function() {
  function t2(t3, e, n2) {
    void 0 === e ? e = 0 : e > t3.length && x2(), void 0 === n2 ? n2 = t3.length - e : n2 > t3.length - e && x2(), this.segments = t3, this.offset = e, this.G = n2;
  }
  return Object.defineProperty(t2.prototype, "length", {
    ...
    return t3 = void 0 === t3 ? 1 : t3, this.J(this.segments, this.offset + t3, this.length - t3);
...
var tt = function() {
  ...
  return t2._t = function(e) {
    ...
    return null !== t3 && 0 === Z2.H(this.path, t3.path);
  }, t2.prototype.toString = function() {
...
function at(t2) {
  return "string" == typeof t2 ? U2.fromBase64String(t2) : U2.fromUint8Array(t2);
}
function ct(t2) {
  var e, n2;
...
function dt(t2) {
  return "number" == typeof t2 && Number.isInteger(t2) && !pt(t2) && t2 <= Number.MAX_SAFE_INTEGER && t2 >= Number.MIN_SAFE_INTEGER;
}
function vt(t2) {
    ...
    case 10:
      return function(t3, e2) {
        ...
        if (et(n3) !== et(r2))
          return false;
        for (var i in n3)
          if (n3.hasOwnProperty(i) && (void 0 === r2[i] || !yt(n3[i], r2[i])))
            return false;
        return true;
      }(t2, e);
    default:
  ...
  switch (n2) {
    ...
    case 8:
      return function(t3, e2) {
        ...
        return 0 !== n3 ? n3 : C(st(t3.longitude), st(e2.longitude));
...
function wt(t2, e) {
  ...
  return 0 !== i ? i : C(n2.nanos, r2.nanos);
}
function bt(t2) {
  return _t(t2);
}
...
var xt = function() {
  function t2(t3) {
    void 0 === t3 && (t3 = St.empty()), this.It = t3, this.At = /* @__PURE__ */ new Map();
  }
  return t2.prototype.set = function(t3, e) {
    ...
    for (var n2 = this.At, r2 = 0; r2 < t3.length - 1; ++r2) {
      ...
      o instanceof Map ? n2 = o : o && 10 === vt(o) ? (o = new Map(Object.entries(o.mapValue.fields || {})), n2.set(i, o), n2 = o) : (o = /* @__PURE__ */ new Map(), n2.set(i, o), n2 = o);
    }
    n2.set(t3.tt(), e);
  }, t2.prototype.Pt = function() {
    var t3 = this.yt($.ct(), this.At);
    return null != t3 ? new St(t3) : this.It;
...
var Lt = function(t2, e, n2, r2, i, o, u) {
  void 0 === e && (e = null), void 0 === n2 && (n2 = []), void 0 === r2 && (r2 = []), void 0 === i && (i = null), void 0 === o && (o = null), void 0 === u && (u = null), this.path = t2, this.collectionGroup = e, this.orderBy = n2, this.filters = r2, this.limit = i, this.startAt = o, this.endAt = u, this.vt = null;
};
function Rt(t2, e, n2, r2, i, o, u) {
  return void 0 === e && (e = null), void 0 === n2 && (n2 = []), void 0 === r2 && (r2 = []), void 0 === i && (i = null), void 0 === o && (o = null), void 0 === u && (u = null), new Lt(t2, e, n2, r2, i, o, u);
}
function Ut(t2) {
  var e = O2(t2);
  if (null === e.vt) {
...
function qt(t2) {
  return tt.wt(t2.path) && null === t2.collectionGroup && 0 === t2.filters.length;
}
var Ft = function(t2) {
  function e(e2, n2, r2) {
    var i = this;
  ...
  return __extends(e, t2), e.create = function(t3, n2, r2) {
    return t3.ut() ? "in" === n2 || "not-in" === n2 ? this.St(t3, n2, r2) : new jt(t3, n2, r2) : "array-contains" === n2 ? new Qt(t3, r2) : "in" === n2 ? new Yt(t3, r2) : "not-in" === n2 ? new Ht(t3, r2) : "array-contains-any" === n2 ? new Kt(t3, r2) : new e(t3, n2, r2);
  }, e.St = function(t3, e2, n2) {
    return "in" === e2 ? new zt(t3, n2) : new Gt(t3, n2);
  }, e.prototype.matches = function(t3) {
    var e2 = t3.field(this.field);
    return "!=" === this.op ? null !== e2 && this.Dt(gt(e2, this.value)) : null !== e2 && vt(this.value) === vt(e2) && this.Dt(gt(e2, this.value));
...
var Yt = function(t2) {
  ...
  return __extends(e, t2), e.prototype.matches = function(t3) {
    var e2 = t3.field(this.field);
    return null !== e2 && mt(this.value.arrayValue, e2);
  }, e;
}(Ft);
var Ht = function(t2) {
  function e(e2, n2) {
...
function $t(t2, e, n2) {
  for (var r2 = 0, i = 0; i < t2.position.length; i++) {
    ...
    if (r2 = o.field.ut() ? tt.H(tt.ft(u.referenceValue), n2.key) : gt(u, n2.field(o.field)), "desc" === o.dir && (r2 *= -1), 0 !== r2)
      break;
  }
...
var ee = function(t2, e, n2, r2, i, o, u, s) {
  void 0 === e && (e = null), void 0 === n2 && (n2 = []), void 0 === r2 && (r2 = []), void 0 === i && (i = null), void 0 === o && (o = "F"), void 0 === u && (u = null), void 0 === s && (s = null), this.path = t2, this.collectionGroup = e, this.xt = n2, this.filters = r2, this.limit = i, this.limitType = o, this.startAt = u, this.endAt = s, this.Nt = null, this.$t = null, this.startAt, this.endAt;
};
...
function ie(t2) {
  return !lt(t2.limit) && "F" === t2.limitType;
}
function oe(t2) {
  return !lt(t2.limit) && "L" === t2.limitType;
}
function ue(t2) {
  ...
  if (!e.$t)
    if ("F" === e.limitType)
      ...
      for (var n2 = [], r2 = 0, i = ce(e); r2 < i.length; r2++) {
        var o = i[r2], u = "desc" === o.dir ? "asc" : "desc";
...
function ve(t2, e) {
  return function(t3, e2) {
    var n2 = e2.key.path;
    return null !== t3.collectionGroup ? e2.key.dt(t3.collectionGroup) && t3.path.nt(n2) : tt.wt(t3.path) ? t3.path.isEqual(n2) : t3.path.st(n2);
  }(t2, e) && function(t3, e2) {
    for (var n2 = 0, r2 = t3.xt; n2 < r2.length; n2++) {
      var i = r2[n2];
      if (!i.field.ut() && null === e2.field(i.field))
        return false;
    }
    return true;
  }(t2, e) && function(t3, e2) {
...
function me(t2, e, n2) {
  var r2 = t2.field.ut() ? tt.H(e.key, n2.key) : function(t3, e2, n3) {
    ...
    return null !== r3 && null !== i ? gt(r3, i) : x2();
  }(t2.field, e, n2);
  switch (t2.dir) {
    case "asc":
      return r2;
...
var ge = function() {
  function t2(t3, e, n2, r2, i, o, u) {
    void 0 === i && (i = X2.min()), void 0 === o && (o = X2.min()), void 0 === u && (u = U2.T), this.target = t3, this.targetId = e, this.Ft = n2, this.sequenceNumber = r2, this.Ot = i, this.lastLimboFreeSnapshotVersion = o, this.resumeToken = u;
  }
...
function Ue(t2, e) {
  return void 0 !== t2.updateTime ? e instanceof Pt && e.version.isEqual(t2.updateTime) : void 0 === t2.exists || t2.exists === e instanceof Pt;
}
var Me = function() {
};
function qe(t2, e, n2) {
...
function je(t2, e) {
  return function(t3, e2) {
    for (var n2 = null, r2 = 0, i = t3; r2 < i.length; r2++) {
      ...
      null != s && (n2 = null == n2 ? new xt().set(o.field, s) : n2.set(o.field, s));
    }
...
function ze(t2, e) {
  return t2.type === e.type && !!t2.key.isEqual(e.key) && !!t2.jt.isEqual(e.jt) && !!function(t3, e2) {
    return void 0 === t3 && void 0 === e2 || !(!t3 || !e2) && L2(t3, e2, function(t4, e3) {
  ...
  }(t2.fieldTransforms, e.fieldTransforms) && (0 === t2.type ? t2.value.isEqual(e.value) : 1 !== t2.type || t2.data.isEqual(e.data) && t2.Gt.isEqual(e.Gt));
}
function Ge(t2) {
...
var un = function() {
  ...
  return t2.prototype.copy = function(e, n2, r2, i, o) {
    ...
    return (r2 = i < 0 ? r2.copy(null, null, null, r2.left.zt(t3, e, n2), null) : 0 === i ? r2.copy(null, e, null, null, null) : r2.copy(null, null, null, null, r2.right.zt(t3, e, n2))).ue();
    ...
    if (n2(e, i.key) < 0)
      ...
      if (i.left.le() && (i = i.fe()), i.right.et() || i.right.le() || i.right.left.le() || (i = i.de()), 0 === n2(e, i.key)) {
        if (i.right.et())
          return t2.EMPTY;
...
var sn = function() {
  ...
  return t2.prototype.has = function(t3) {
    ...
    var n2;
    for (n2 = void 0 !== e ? this.data.ee(e) : this.data.te(); n2.ce(); )
      if (!t3(n2.oe().key))
        return;
...
var _n = function() {
  ...
  return t2.prototype.track = function(t3) {
    ...
    n2 ? 0 !== t3.type && 3 === n2.type ? this.be = this.be.zt(e, t3) : 3 === t3.type && 1 !== n2.type ? this.be = this.be.zt(e, {
      type: n2.type,
      doc: t3.doc
    }) : 2 === t3.type && 2 === n2.type ? this.be = this.be.zt(e, {
      type: 2,
      doc: t3.doc
    }) : 2 === t3.type && 0 === n2.type ? this.be = this.be.zt(e, {
      type: 0,
      doc: t3.doc
    }) : 1 === t3.type && 0 === n2.type ? this.be = this.be.remove(e) : 1 === t3.type && 2 === n2.type ? this.be = this.be.zt(e, {
      type: 1,
      doc: n2.doc
    }) : 0 === t3.type && 1 === n2.type ? this.be = this.be.zt(e, {
      type: 2,
      doc: t3.doc
...
var Dn = function(t2, e, n2, r2) {
  void 0 === n2 && (n2 = U2.T), void 0 === r2 && (r2 = null), this.state = t2, this.targetIds = e, this.resumeToken = n2, this.cause = r2;
};
var Sn = function() {
  function t2() {
...
var xn = function() {
  function t2(t3) {
    this.un = t3, this.hn = /* @__PURE__ */ new Map(), this.ln = hn(), this._n = kn(), this.fn = new sn(C);
  }
  return t2.prototype.dn = function(t3) {
    ...
    this.hn.forEach(function(r3, i2) {
      ...
      if (o) {
        if (r3.Be && qt(o.target)) {
          ...
          null !== e.ln.get(u) || e.pn(i2, u) || e.En(i2, u, new Vt(u, t3));
        }
    ...
    this._n.forEach(function(t4, n3) {
      ...
      n3.Ae(function(t5) {
        var n4 = e.yn(t5);
        return !n4 || 2 === n4.Ft || (i2 = false, false);
      }), i2 && (r2 = r2.add(t4));
    });
...
function Bn(t2) {
  var e = Fn(t2);
  return 4 === e.length ? Z2.ct() : Yn(e);
}
function Qn(t2) {
  return new Z2(["projects", t2.t.projectId, "databases", t2.t.database]).rt();
}
function Yn(t2) {
  return k2(t2.length > 4 && "documents" === t2.get(4)), t2.Y(5);
}
function Hn(t2, e, n2) {
  return {
    name: jn(t2, e),
...
function Wn(t2, e) {
  var n2 = e.currentDocument ? function(t3) {
    return void 0 !== t3.updateTime ? Re.updateTime(Mn(t3.updateTime)) : void 0 !== t3.exists ? Re.exists(t3.exists) : Re.Kt();
  }(e.currentDocument) : Re.Kt(), r2 = e.updateTransforms ? e.updateTransforms.map(function(e2) {
    return function(t3, e3) {
      var n3 = null;
      if ("setToServerValue" in e3)
        k2("REQUEST_TIME" === e3.setToServerValue), n3 = new Ae();
...
function Jn(t2, e) {
  ...
  null !== e.collectionGroup ? (n2.parent = Gn(t2, r2), n2.structuredQuery.from = [{
  ...
  return null !== u && (n2.structuredQuery.limit = u), e.startAt && (n2.structuredQuery.startAt = er(e.startAt)), e.endAt && (n2.structuredQuery.endAt = er(e.endAt)), n2;
}
function $n(t2) {
  ...
  n2.limit && (a = function(t3) {
    var e2;
    return lt(e2 = "object" == typeof t3 ? t3.value : t3) ? null : e2;
  }(n2.limit));
  var c = null;
...
function tr(t2) {
  return t2 ? void 0 !== t2.unaryFilter ? [ar(t2)] : void 0 !== t2.fieldFilter ? [sr(t2)] : void 0 !== t2.compositeFilter ? t2.compositeFilter.filters.map(function(t3) {
    return tr(t3);
...
var dr = function() {
  function t2(e, r2, i) {
    this.name = e, this.version = r2, this.Un = i, 12.2 === t2.Qn(getUA()) && A2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  return t2.delete = function(t3) {
    ...
    var t3;
    return "undefined" != typeof process && "YES" === (null === (t3 = process.env) || void 0 === t3 ? void 0 : t3.Gn);
  }, t2.zn = function(t3, e) {
    return t3.store(e);
  }, t2.Qn = function(t3) {
          ...
          case 0:
            return this.db ? [3, 2] : (N2("SimpleDb", "Opening database:", this.name), e = this, [4, new Promise(function(e2, r3) {
              ...
              i.onsuccess = function(t4) {
                ...
                "VersionError" === n3.name ? r3(new q2(M2.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r3(new yr(t3, n3));
            ...
            i = "readonly" === e, o = 0, u = function() {
              ...
              return __generator(this, function(f) {
                switch (f.label) {
                  ...
                  case 4:
                    return c2 = f.sent(), h2 = "FirebaseError" !== c2.name && o < 3, N2("SimpleDb", "Transaction failed with error:", c2.message, "Retrying:", h2), s.close(), h2 ? [3, 5] : [2, {
...
var gr = function() {
  ...
  return t2.prototype.put = function(t3, e) {
    var n2;
    return void 0 !== e ? (N2("SimpleDb", "PUT", this.store.name, t3, e), n2 = this.store.put(e, t3)) : (N2("SimpleDb", "PUT", this.store.name, "<auto-key>", t3), n2 = this.store.put(t3)), wr(n2);
  }, t2.prototype.add = function(t3) {
    ...
    return new lr(function(r2, i) {
      t3.onerror = function(t4) {
        ...
        if (i2) {
          ...
          o.xn ? r2() : null === o.ns ? i2.continue() : i2.continue(o.ns);
        } else
          r2();
      };
    }).next(function() {
...
var Ir = function() {
  ...
  return t2.Ts = function(e, n2, r2, i, o) {
    ...
    null !== this.Is && (this.clearTimeout(), this.Es.reject(new q2(M2.CANCELLED, "Operation cancelled" + (t3 ? ": " + t3 : ""))));
  }, t2.prototype.As = function() {
    var t3 = this;
    this._s.Ps(function() {
      return null !== t3.Is ? (t3.clearTimeout(), t3.op().then(function(e) {
  ...
  for (var n2 = e - 2, r2 = [], i = "", o = 0; o < e; ) {
    ...
    switch ((u < 0 || u > n2) && x2(), t2.charAt(u + 1)) {
      case "":
        ...
        0 === i.length ? a = s : (a = i += s, i = ""), r2.push(a);
        break;
      case "":
...
function oi(t2) {
  var e, n2, r2 = ri(t2.readTime), i = void 0 !== t2.lastLimboFreeSnapshotVersion ? ri(t2.lastLimboFreeSnapshotVersion) : X2.min();
  return void 0 !== t2.query.documents ? (k2(1 === (n2 = t2.query).documents.length), e = he(re(Bn(n2.documents[0])))) : e = function(t3) {
    return he($n(t3));
...
function si(t2) {
  ...
  return "LAST" === t2.limitType ? fe(e, e.limit, "L") : e;
}
var ai = function() {
  function t2() {
  }
  ...
  return t2.prototype.get = function(t3) {
    ...
    for (var r2 = 0; r2 < n2.length; r2++)
      if (this.si(n2[r2][0], t3))
        return 1 === n2.length ? delete this.ii[e] : n2.splice(r2, 1), true;
    return false;
  }, t2.prototype.forEach = function(t3) {
...
var wi = function() {
  ...
  return t2.prototype.ci = function(t3) {
    ...
    void 0 === e && (e = null), this.ui(), this.ri.set(t3, {
      hi: null,
      readTime: e
    });
    ...
    return void 0 !== n2 ? lr.resolve(n2.hi) : this.fi(t3, e);
...
var Si = function() {
  ...
  return t2.prototype.Bi = function(t3) {
    ...
    return xi(t3).hs(function(u, s) {
      var a = oi(s);
      a.sequenceNumber <= e && null === n2.get(a.targetId) && (i++, o.push(r2.Ji(t3, a)));
    }).next(function() {
      return lr.Mn(o);
    }).next(function() {
      return i;
    ...
    var n2 = Oi(t3), r2 = IDBKeyRange.bound(
      [e],
      [e + 1],
      false,
      true
    ...
    var n2 = Ar(e.path), r2 = IDBKeyRange.bound(
      [n2],
      [R2(n2)],
      false,
      true
...
var Ci = function() {
  ...
  return t2.prototype.start = function(t3) {
    -1 !== this.lr.params.zs && this.wr(t3);
...
var Li = function() {
  ...
  return t2.prototype.Ar = function(t3, e) {
    ...
    var n2 = this;
    return -1 === this.params.zs ? (N2("LruGarbageCollector", "Garbage collection skipped; disabled"), lr.resolve(vi)) : this.pr(t3).next(function(r2) {
...
var Ri = function() {
  ...
  return t2.prototype.Rr = function(t3) {
    ...
    return r2.hs({
      ...
      0 === o ? (i !== H2.q && e(new tt(xr(n2)), i), i = s, n2 = u) : i = H2.q;
    }).next(function() {
...
var Mi = function() {
  ...
  return t2.prototype.ai = function(t3, e, n2) {
    ...
    if (n2.isEqual(X2.min())) {
      ...
      u.range = IDBKeyRange.lowerBound(
        [a, c],
        true
      ), u.index = Ur.collectionReadTimeIndex;
    }
...
var qi = function(t2) {
  ...
  return __extends(e, t2), e.prototype.wi = function(t3) {
    ...
    return this.jr.Lr(t3, e2).next(function(t4) {
      return null === t4 ? (n2.Gr.set(e2, 0), null) : (n2.Gr.set(e2, t4.size), t4.hi);
    });
...
var Gi = function() {
  ...
  return t2.prototype.Jn = function(t3, e, n2, r2) {
    ...
    return n2 < 3 && r2 >= 3 && (0 !== n2 && (function(t4) {
      ...
      return function(t4) {
        var e2 = t4.store(jr.store), n3 = new jr(
          0,
          0,
          X2.min().j(),
          0
...
var Yi = function() {
  function t2(e, n2, r2, i, o, u, s, a, c, h2) {
    ...
    this.Ti = new Ri(this, i), this.ho = n2 + "main", this.Qt = new Zr(a), this.lo = new dr(this.ho, 11, new Gi(this.Qt)), this._o = new Si(this.Ti, this.Qt), this.Ei = new pi(), this.fo = function(t3, e2) {
      return new Mi(t3, e2);
    }(this.Qt, this.Ei), this.wo = new ai(), this.window && this.window.localStorage ? this.Eo = this.window.localStorage : (this.Eo = null, false === h2 && A2("IndexedDbPersistence", "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  return t2.prototype.start = function() {
    ...
    return this.no ? lr.resolve(true) : Hi(t3).get(Or.key).next(function(n2) {
      if (null !== n2 && e.No(n2.leaseTimestampMs, 5e3) && !e.Oo(n2.ownerId)) {
      ...
      return !(!e.networkEnabled || !e.inForeground) || Ki(t3).rs().next(function(t4) {
        return void 0 === e.$o(t4, 5e3).find(function(t5) {
    ...
    return this.lo.runTransaction(t3, o, Yr, function(o2) {
      return i = new Hr(o2, r2.so ? r2.so.next() : H2.q), "readwrite-primary" === e ? r2.Vo(i).next(function(t4) {
        return !!t4 || r2.bo(i);
      }).next(function(e2) {
        if (!e2)
    ...
    var e = this;
    return Hi(t3).get(Or.key).next(function(t4) {
      if (null !== t4 && e.No(t4.leaseTimestampMs, 5e3) && !e.Oo(t4.ownerId) && !e.Do(t4) && !(e.no || e.allowTabSynchronization && t4.allowTabSynchronization))
        throw new q2(M2.FAILED_PRECONDITION, Qi);
    });
    ...
    null !== this.document && "function" == typeof this.document.addEventListener && (this.oo = function() {
      t3.Zr.Ps(function() {
        return t3.inForeground = "visible" === t3.document.visibilityState, t3.To();
      });
    ...
    var t3, e = this;
    "function" == typeof (null === (t3 = this.window) || void 0 === t3 ? void 0 : t3.addEventListener) && (this.ro = function() {
    ...
    var e;
    try {
      var n2 = null !== (null === (e = this.Eo) || void 0 === e ? void 0 : e.getItem(this.Fo(t3)));
...
var Zi = function() {
  ...
  return t2.prototype.Ho = function(t3, e) {
    ...
    return function(t4) {
      return tt.wt(t4.path) && null === t4.collectionGroup && 0 === t4.filters.length;
    ...
    return this.fo.getEntries(t3, r2).next(function(t4) {
      return t4.forEach(function(t5, e2) {
        null !== e2 && e2 instanceof Pt && (c = c.zt(t5, e2));
      }), c;
    });
  }, t2;
}();
...
var $i = function() {
  ...
  return t2.prototype.cc = function(t3) {
    ...
    var o = this;
    return function(t4) {
      return 0 === t4.filters.length && null === t4.limit && null == t4.startAt && null == t4.endAt && (0 === t4.xt.length || 1 === t4.xt.length && t4.xt[0].field.ut());
    ...
    return function(t4, e2, n3, r3) {
      ...
      return o.forEach(function(t5) {
        u = u.next(function() {
          ...
          k2(null !== u2), (!o2 || o2.version._(u2) < 0) && ((o2 = i2.Ss(t5, o2, n3)) && r3.ai(o2, n3.Ns));
        });
      }), u.next(function() {
      ...
      if (s2) {
        ...
        if (a2.l() > 0) {
          ...
          i = i.zt(o2, c), function(t4, e3, n3) {
            return k2(e3.resumeToken.l() > 0), 0 === t4.resumeToken.l() || (e3.Ot.W() - t4.Ot.W() >= 3e8 || n3.qe.size + n3.Ue.size + n3.Qe.size > 0);
...
function uo(t2, e, n2, r2, i) {
  ...
  return n2.forEach(function(t3) {
    ...
    return n2.forEach(function(n3, u) {
      var s = t3.get(n3), a = (null == i ? void 0 : i.get(n3)) || r2;
      u instanceof Vt && u.version.isEqual(X2.min()) ? (e.li(n3, a), o2 = o2.zt(n3, u)) : null == s || u.version._(s.version) > 0 || 0 === u.version._(s.version) && s.hasPendingWrites ? (e.ai(u, a), o2 = o2.zt(n3, u)) : N2("LocalStore", "Ignoring outdated watch update for ", n3, ". Current version:", s.version, " Watch version:", u.version);
    }), o2;
  });
}
function so(t2, e) {
  ...
  return n2.persistence.runTransaction("Get next mutation batch", "readonly", function(t3) {
    return void 0 === e && (e = -1), n2.zo.gi(t3, e);
  });
}
function ao(t2, e) {
  var n2 = O2(t2);
  return n2.persistence.runTransaction("Allocate target", "readwrite", function(t3) {
    ...
    return (null === r2 || t3.Ot._(r2.Ot) > 0) && (n2.fc = n2.fc.zt(t3.targetId, t3), n2.dc.set(e, t3.targetId)), t3;
  });
}
function co(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
...
function ho(t2, e, n2) {
  ...
  return r2.persistence.runTransaction("Execute query", "readonly", function(t3) {
    return function(t4, e2, n3) {
      ...
      return void 0 !== i2 ? lr.resolve(r3.fc.get(i2)) : r3._o.tr(e2, n3);
...
function yo(t2, e, n2) {
  return void 0 === n2 && (n2 = mn()), __awaiter(this, void 0, void 0, function() {
    var r2, i;
    return __generator(this, function(o) {
      switch (o.label) {
        case 0:
...
var mo = function() {
  function t2(t3) {
    this.Qt = t3, this.Vc = /* @__PURE__ */ new Map(), this.bc = /* @__PURE__ */ new Map();
  }
  return t2.prototype.Os = function(t3, e) {
...
var bo = function() {
  ...
  return t2.prototype.Ai = function(t3) {
    ...
    var n2 = this;
    k2(0 === this.Kc(e.batchId, "removed")), this.zo.shift();
    var r2 = this.Bc;
    ...
    return 0 === this.zo.length ? 0 : t3 - this.zo[0].batchId;
  }, t2.prototype.qc = function(t3) {
    var e = this.Uc(t3);
...
var Eo = function() {
  ...
  return t2.prototype.In = function(t3, e) {
    ...
    return this.Gc.forEach(function(u, s) {
      s.sequenceNumber <= e && null === n2.get(s.targetId) && (r2.Gc.delete(u), o.push(r2.Yi(t3, s.targetId)), i++);
...
var ko = function() {
  ...
  return t2.ca = function(e, n2, r2) {
    var i, o = JSON.parse(r2), u = "object" == typeof o && -1 !== ["pending", "acknowledged", "rejected"].indexOf(o.state) && (void 0 === o.error || "object" == typeof o.error);
    return u && o.error && ((u = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new q2(o.error.code, o.error.message))), u ? new t2(e, n2, o.state, i) : (A2("SharedClientState", "Failed to parse mutation state for ID '" + n2 + "': " + r2), null);
...
var Oo = function() {
  ...
  return t2.ca = function(e, n2) {
    ...
    return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (r2 = new q2(i.error.code, i.error.message))), o ? new t2(e, i.state, r2) : (A2("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n2), null);
  }, t2.prototype.aa = function() {
    var t3 = {
      state: this.state,
      updateTimeMs: Date.now()
...
var Po = function() {
  ...
  return t2.ca = function(e, n2) {
    for (var r2 = JSON.parse(n2), i = "object" == typeof r2 && r2.activeTargetIds instanceof Array, o = wn(), u = 0; i && u < r2.activeTargetIds.length; ++u)
...
var Lo = function() {
  ...
  return t2.Kn = function(t3) {
            ...
            if (this.Er) {
              if (null !== n2.key) {
                if (this.Aa.test(n2.key)) {
                  ...
                  if (null !== n2.newValue && (r2 = this.Ja(n2.key, n2.newValue)))
                    return [2, this.Ya(r2)];
                } else if (this.Pa.test(n2.key)) {
                  if (null !== n2.newValue && (i = this.Xa(n2.key, n2.newValue)))
                    return [2, this.Za(i)];
                } else if (n2.key === this.ya) {
                  if (null !== n2.newValue && (o = this.pa(n2.newValue)))
                    return [2, this.ba(o)];
    ...
    var n2 = this.Ra.exec(t3), r2 = Number(n2[1]), i = void 0 !== n2[2] ? n2[2] : null;
    ...
    return I4(g, WebChannel.EventType.OPEN, function() {
      ...
      if (!b) {
        ...
        if (i) {
          ...
          void 0 === u && (u = M2.INTERNAL, s = "Unknown error status: " + o + " with message " + i.message), b = true, _2.Ru(new q2(u, s)), g.close();
        } else
...
var Qo = function() {
  function t2(t3, e, n2, r2, i) {
    void 0 === n2 && (n2 = 1e3), void 0 === r2 && (r2 = 1.5), void 0 === i && (i = 6e4), this.Zr = t3, this.fs = e, this.xu = n2, this.Nu = r2, this.$u = i, this.Fu = 0, this.Ou = null, this.ku = Date.now(), this.reset();
  }
  ...
  return t2.prototype.zu = function() {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(n2) {
        switch (n2.label) {
          case 0:
            return this.eh(), this.Gu.cancel(), this.Wu++, 3 !== t3 ? this.Gu.reset() : e && e.code === M2.RESOURCE_EXHAUSTED ? (A2(e.toString()), A2("Using maximum backoff delay to prevent overloading the backend."), this.Gu.Mu()) : e && e.code === M2.UNAUTHENTICATED && this.Ku.p(), null !== this.stream && (this.nh(), this.stream.close(), this.stream = null), this.state = t3, [4, this.listener.Tu(e)];
          case 1:
            return n2.sent(), [2];
        }
      });
  ...
  return __extends(e, t2), e.prototype.oh = function(t3) {
    ...
    var e2 = function(t4, e3) {
      ...
      if ("targetChange" in e3) {
        e3.targetChange;
        var r2 = function(t5) {
          return "NO_CHANGE" === t5 ? 0 : "ADD" === t5 ? 1 : "REMOVE" === t5 ? 2 : "CURRENT" === t5 ? 3 : "RESET" === t5 ? 4 : x2();
        }(e3.targetChange.targetChangeType || "NO_CHANGE"), i = e3.targetChange.targetIds || [], o = function(t5, e4) {
          return t5.Bt ? (k2(void 0 === e4 || "string" == typeof e4), U2.fromBase64String(e4 || "")) : (k2(void 0 === e4 || e4 instanceof Uint8Array), U2.fromUint8Array(e4 || new Uint8Array()));
        }(t4, e3.targetChange.resumeToken), u = (s = e3.targetChange.cause) && function(t5) {
          var e4 = void 0 === t5.code ? M2.UNKNOWN : nn(t5.code);
...
var Ko = function(t2) {
  ...
  return __extends(e, t2), Object.defineProperty(e.prototype, "_h", {
    ...
    if (k2(!!t3.streamToken), this.lastStreamToken = t3.streamToken, this.lh) {
      this.Gu.reset();
      var e2 = function(t4, e3) {
        return t4 && t4.length > 0 ? (k2(void 0 !== e3), t4.map(function(t5) {
    ...
    return k2(!t3.writeResults || 0 === t3.writeResults.length), this.lh = true, this.listener.wh();
...
var Wo = function() {
  ...
  return t2.prototype.Ph = function() {
    ...
    "Online" === this.state ? this.yh("Unknown") : (this.mh++, this.mh >= 1 && (this.ph(), this.gh("Connection failed 1 times. Most recent error: " + t3.toString()), this.yh("Offline")));
  }, t2.prototype.set = function(t3) {
    this.ph(), this.mh = 0, "Online" === t3 && (this.Rh = false), this.yh(t3);
...
var Zo = function(t2, e, n2, r2, i) {
  var o = this;
  this.bh = t2, this.Sh = e, this._s = n2, this.Dh = {}, this.Ch = [], this.xh = /* @__PURE__ */ new Map(), this.Nh = /* @__PURE__ */ new Set(), this.$h = [], this.Fh = i, this.Fh.ou(function(t3) {
    n2.Ps(function() {
...
function eu(t2, e) {
  ...
  n2.xh.delete(e), r2.Hu() && ru(n2, e), 0 === n2.xh.size && (r2.Hu() ? r2.Xu() : uu(n2) && n2.Oh.set("Unknown"));
}
function nu(t2, e) {
...
function hu(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(u) {
      switch (u.label) {
        case 0:
          if (t2.Oh.set("Online"), !(e instanceof Dn && 2 === e.state && e.cause))
            return [3, 6];
          u.label = 1;
        case 1:
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(u) {
      switch (u.label) {
        ...
        case 3:
          return null === (i = u.sent()) ? (0 === e.Ch.length && n2.Xu(), [3, 7]) : (r2 = i.batchId, function(t3, e2) {
            t3.Ch.push(e2);
            var n3 = Iu(t3);
...
var Tu = function() {
  this.queries = new gi(function(t2) {
    return pe(t2);
  }, le), this.onlineState = "Unknown", this.Wh = /* @__PURE__ */ new Set();
};
function Nu(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    var n2, r2, i, o, u, s, a;
...
function Au(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    var n2, r2, i, o, u;
    return __generator(this, function(s) {
      return n2 = O2(t2), r2 = e.query, i = false, (o = n2.queries.get(r2)) && (u = o.listeners.indexOf(e)) >= 0 && (o.listeners.splice(u, 1), i = 0 === o.listeners.length), i ? [2, (n2.queries.delete(r2), n2.Hh(r2))] : [2];
    });
  });
}
function Du(t2, e) {
...
var Vu = function() {
  ...
  return t2.prototype.rl = function(t3) {
    ...
    for (var e = /* @__PURE__ */ new Map(), n2 = new Pu(this.Qt), r2 = 0, i = t3; r2 < i.length; r2++) {
      var o = i[r2];
...
var Uu = function() {
  ...
  return Object.defineProperty(t2.prototype, "_l", {
    ...
    var u = e ? this.Tl() : [], s = 0 === this.ul.size && this.Be ? 1 : 0, a = s !== this.al;
    ...
    return this.Be && "Offline" === t3 ? (this.Be = false, this.wi(
      {
        ll: this.ll,
        dl: new _n(),
        De: this.De,
    ...
    return In.Ne(this.query, this.ll, this.De, 0 === this.al);
  }, t2;
}();
...
var Fu = function() {
  function t2(t3, e, n2, r2, i, o) {
    this.bh = t3, this.yl = e, this.gl = n2, this.Vl = r2, this.currentUser = i, this.pl = o, this.bl = {}, this.vl = new gi(function(t4) {
      return pe(t4);
    }, le), this.Sl = /* @__PURE__ */ new Map(), this.Dl = /* @__PURE__ */ new Set(), this.Cl = new rn(tt.H), this.xl = /* @__PURE__ */ new Map(), this.Nl = new go(), this.$l = {}, this.Fl = /* @__PURE__ */ new Map(), this.Ol = Di.Li(), this.onlineState = "Unknown", this.kl = void 0;
  }
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(a) {
      switch (a.label) {
        ...
        case 2:
          return u = a.sent(), s = n2.Vl.Fa(u.targetId), r2 = u.targetId, [4, zu(n2, e, r2, "current" === s)];
        case 3:
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(h2) {
      switch (h2.label) {
            ...
            return function(t3, e3, n4, r4) {
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(s2) {
                  switch (s2.label) {
                    case 0:
                      return i2 = e3.view.fl(n4), i2.lc ? [4, ho(
                        t3.bh,
                        e3.query,
                        false
                      ).then(function(t4) {
                    ...
                    case 2:
                      return o2 = r4 && r4.$e.get(e3.targetId), u2 = e3.view.wi(
                        i2,
                        t3.Ml,
                        o2
                      ), [2, (es(t3, e3.targetId, u2.Il), u2.snapshot)];
                  }
                });
              });
            }(t2, e2, n3, r3);
        ...
        case 1:
          return i = h2.sent(), o = new Uu(e, i.Rc), u = o.fl(i.documents), s = Tn.Le(n2, r2 && "Offline" !== t2.onlineState), a = o.wi(
            u,
            t2.Ml,
            s
          ), es(t2, n2, a.Il), c = new Mu(e, n2, o), [2, (t2.vl.set(e, c), t2.Sl.has(n2) ? t2.Sl.get(n2).push(e) : t2.Sl.set(n2, [e]), a.snapshot)];
      }
    });
  });
}
      ...
      switch (o.label) {
        case 0:
          return n2 = O2(t2), r2 = n2.vl.get(e), (i = n2.Sl.get(r2.targetId)).length > 1 ? [2, (n2.Sl.set(r2.targetId, i.filter(function(t3) {
            return !le(t3, e);
          })), void n2.vl.delete(e))] : n2.Ml ? (n2.Vl.ka(r2.targetId), n2.Vl.Da(r2.targetId) ? [3, 2] : [4, co(
            n2.bh,
            r2.targetId,
            false
          ).then(function() {
            ...
            return r3.persistence.runTransaction("Locally write mutations", "readwrite", function(t4) {
              return r3.Tc.Xo(t4, o2).next(function(o3) {
                ...
                for (var u2 = [], s2 = 0, a = e2; s2 < a.length; s2++) {
                  ...
                  null != h2 && u2.push(new Qe(c.key, h2, kt(h2.proto.mapValue), Re.exists(true)));
                }
...
function Hu(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(c) {
      switch (c.label) {
        case 0:
          return (r2 = O2(t2)).Vl.Ba(e, "rejected", n2), i = r2.xl.get(e), (o = i && i.key) ? (u = (u = new rn(tt.H)).zt(o, new Vt(o, X2.min())), s = mn().add(o), a = new En(
            X2.min(),
            /* @__PURE__ */ new Map(),
            new sn(C),
            u,
          ...
          return o.trys.push([1, 4, , 6]), [4, function(t3, e2) {
            ...
            return n3.persistence.runTransaction("Reject batch", "readwrite-primary", function(t4) {
              ...
              return n3.zo.Pi(t4, e2).next(function(e3) {
                return k2(null !== e3), r3 = e3.keys(), n3.zo.Ci(t4, e3);
              }).next(function() {
                return n3.zo.$i(t4);
              }).next(function() {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(s) {
      switch (s.label) {
        ...
        case 2:
          return -1 === (r2 = s.sent()) ? [2, void e.resolve()] : ((i = n2.Fl.get(r2) || []).push(e), n2.Fl.set(r2, i), [3, 4]);
        case 3:
...
function ts(t2, e) {
  ...
  var n2 = t2.Cl.get(e);
  null !== n2 && (eu(t2.yl, n2), t2.Cl = t2.Cl.remove(e), t2.xl.delete(n2), rs(t2));
}
function es(t2, e, n2) {
  for (var r2 = 0, i = n2; r2 < i.length; r2++) {
    var o = i[r2];
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(u) {
      switch (u.label) {
        ...
        case 1:
          return null === (o = u.sent()) ? [3, 6] : "pending" !== n2 ? [3, 3] : [4, pu(i.yl)];
        case 2:
          return u.sent(), [3, 4];
        case 3:
          "acknowledged" === n2 || "rejected" === n2 ? (Ju(i, e, r2 || null), Zu(i, e), function(t3, e2) {
            O2(O2(t3).zo).xi(e2);
          }(i.bh, e)) : x2(), u.label = 4;
        case 4:
          return [4, is(i, o)];
...
function hs(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(h2) {
      switch (h2.label) {
        case 0:
          return ys(n2 = O2(t2)), ms(n2), true !== e || true === n2.kl ? [3, 3] : (r2 = n2.Vl.va(), [4, fs(n2, r2.it())]);
        case 1:
        ...
        case 2:
          ...
          return [3, 7];
        case 3:
          return false !== e || false === n2.kl ? [3, 7] : (a = [], c = Promise.resolve(), n2.Sl.forEach(function(t3, e2) {
        ...
        case 5:
          return h2.sent(), function(t3) {
            ...
            e2.xl.forEach(function(t4, n3) {
              eu(e2.yl, n3);
            }), e2.Nl.Oc(), e2.xl = /* @__PURE__ */ new Map(), e2.Cl = new rn(tt.H);
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(y2) {
      switch (y2.label) {
        ...
        case 1:
          return o < u.length ? (s = u[o], a = void 0, (c = n3.Sl.get(s)) && 0 !== c.length ? [4, ao(n3.bh, he(c[0]))] : [3, 7]) : [3, 13];
        case 2:
    ...
    return __generator(this, function(s) {
      switch (s.label) {
        ...
        case 2:
          return [4, lo(i.bh)];
        case 3:
          return o = s.sent(), u = En.Me(e, "current" === n2), [4, is(i, o, u)];
        case 4:
          return s.sent(), [3, 8];
        case 5:
          return [4, co(
...
var bs = function(t2) {
  ...
  return __extends(e, t2), e.prototype.initialize = function(e2) {
    ...
    var e2 = Xi(t3.yu.t, t3.yu.persistenceKey), n2 = void 0 !== this.cacheSizeBytes ? yi.Ys(this.cacheSizeBytes) : yi.ti;
  ...
  return t2.prototype.initialize = function(t3, e) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(r2) {
        switch (r2.label) {
          case 0:
            return this.bh ? [3, 2] : (this.bh = t3.bh, this.Vl = t3.Vl, this.Sh = this.Xl(e), this.yl = this.Zl(e), this.gl = this.t_(e), this._a = this.e_(
              e,
              !t3.synchronizeTabs
            ), this.Vl.fa = function(t4) {
      ...
      return __generator(this, function(i) {
        switch (i.label) {
          case 0:
            return [4, this.a_()];
          case 1:
            return null === (t3 = i.sent()) ? [2, null] : (e = this.o_.decode(t3), n2 = Number(e), isNaN(n2) && this.u_("length string (" + e + ") is not valid number"), [4, this.h_(n2)]);
          case 2:
      ...
      return __generator(this, function(n2) {
        switch (n2.label) {
          ...
          case 2:
            return [3, 0];
          case 3:
            return 0 === this.buffer.length ? [2, null] : ((t3 = this.l_()) < 0 && this.u_("Reached the end of bundle when a length string is expected."), e = this.buffer.slice(0, t3), [2, (this.buffer = this.buffer.slice(t3), e)]);
        }
      });
    });
...
function Cs(t2) {
  ...
  return "function" == typeof t2 ? "a function" : x2();
}
function Ls(t2, e) {
...
var qs = function() {
  ...
  return Object.defineProperty(t2.prototype, "app", {
    ...
    this.E_ = new Us(t3), void 0 !== t3.credentials && (this.m_ = function(t4) {
      if (!t4)
        return new G2();
      switch (t4.type) {
        case "gapi":
          var e = t4.client;
          return k2(!("object" != typeof e || null === e || !e.auth || !e.auth.getAuthHeaderValueForFirstParty)), new Y2(e, t4.sessionIndex || "0");
        case "provider":
          return t4.client;
        default:
...
function Gs(t2, e) {
  ...
  return Vs(n2 = Z2.ot.apply(Z2, __spreadArrays([t2.path], r2)).child(Z2.ot(e))), new zs(
    t2.firestore,
    null,
    n2
  );
...
function Bs(t2, e) {
  for (var n2, r2 = [], i = 2; i < arguments.length; i++)
    r2[i - 2] = arguments[i];
  if (t2 instanceof Ss && (t2 = t2.d_), 1 === arguments.length && (e = V2.u()), xs("doc", "path", e), t2 instanceof qs)
    return Ps(n2 = Z2.ot.apply(Z2, __spreadArrays([e], r2))), new Fs(
      t2,
      null,
      new tt(n2)
    );
...
var Xs = function() {
  ...
  return t2.prototype.F_ = function(t3, e) {
    return null !== this.Gt ? new Qe(t3, this.data, this.Gt, e, this.fieldTransforms) : new Be(t3, this.data, e, this.fieldTransforms);
  }, t2;
}();
var Ws = function() {
  function t2(t3, e, n2) {
...
var Js = function() {
  function t2(t3, e, n2, r2, i, o) {
    this.settings = t3, this.t = e, this.Qt = n2, this.ignoreUndefinedProperties = r2, void 0 === i && this.O_(), this.fieldTransforms = i || [], this.Gt = o || [];
  }
...
var $s = function() {
  ...
  return t2.prototype.G_ = function(t3, e, n2, r2) {
    return void 0 === r2 && (r2 = false), new Js({
      k_: t3,
      methodName: e,
      j_: n2,
      path: $.ct(),
  ...
  for (var h2 = [], f = new xt(), l = s.length - 1; l >= 0; --l)
    if (!wa(h2, s[l])) {
      ...
      if (d instanceof na2)
        ...
        var y2 = fa2(d, v2);
        null != y2 && (h2.push(p2), f.set(p2, y2));
      }
    }
  var m = new it(h2);
...
function ha2(t2, e, n2, r2) {
  return void 0 === r2 && (r2 = false), fa2(n2, t2.G_(r2 ? 4 : 3, e));
}
function fa2(t2, e) {
  ...
  return function(t3, e2) {
    if (t3 instanceof Ss && (t3 = t3.d_), null === t3)
      return {
        nullValue: "NULL_VALUE"
      };
    if ("number" == typeof t3)
...
function pa2(t2) {
  return !("object" != typeof t2 || null === t2 || t2 instanceof Array || t2 instanceof Date || t2 instanceof K2 || t2 instanceof Hs || t2 instanceof F2 || t2 instanceof Fs || t2 instanceof Ds);
}
...
function ga(t2, e, n2, r2, i) {
  var o = r2 && !r2.et(), u = void 0 !== i, s = "Function " + e + "() called with invalid data";
...
var ba2 = function() {
  function t2(t3) {
    this.Sh = t3, this.Y_ = /* @__PURE__ */ new Map(), this.mutations = [], this.X_ = false, this.Z_ = null, this.tf = /* @__PURE__ */ new Set();
  }
              ...
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(a) {
                  switch (a.label) {
                    ...
                    case 1:
                      return o = a.sent(), u = /* @__PURE__ */ new Map(), o.forEach(function(t5) {
            ...
            return r3 = function(t3, e2, n3, r4, i2) {
              var o2 = new Ts({
                next: function(n4) {
                  e2.Ps(function() {
                    return Au(t3, u);
                  }), n4.fromCache && "server" === r4.source ? i2.reject(new q2(M2.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i2.resolve(n4);
                },
                error: function(t4) {
                  return i2.reject(t4);
                }
    ...
    return __awaiter(r2, void 0, void 0, function() {
      ...
      return __generator(this, function(o) {
        switch (o.label) {
          ...
          case 3:
            if (!function(t3) {
              return "FirebaseError" === t3.name ? t3.code === M2.FAILED_PRECONDITION || t3.code === M2.UNIMPLEMENTED : !("undefined" != typeof DOMException && t3 instanceof DOMException) || (22 === t3.code || 20 === t3.code || 11 === t3.code);
            }(r3 = o.sent()))
              throw r3;
...
var Ga2 = function() {
  ...
  return t2.prototype.Uf = function(t3, e) {
    ...
    switch (e) {
      case "previous":
        var n2 = ht(t3);
        return null == n2 ? null : this.Uf(n2, e);
      case "estimate":
...
function Ya2(t2, e) {
  return "string" == typeof e ? ma2(t2, e) : e instanceof Ss ? e.d_.f_ : e.f_;
}
function Ha2(t2) {
  if (oe(t2) && 0 === t2.xt.length)
  ...
  return __extends(e, t2), e.prototype.td = function(t3) {
    var e2 = ta2(t3.firestore), n2 = function(t4, e3, n3, r2, i, o, u) {
      ...
      if (i.ut()) {
        ...
        "in" !== o && "not-in" !== o && "array-contains-any" !== o || rc2(u, o), s = ha2(
          n3,
          "where",
          u,
          "in" === o || "not-in" === o
...
function nc2(t2, e, n2) {
  if (n2 instanceof Ss && (n2 = n2.d_), "string" == typeof n2) {
    if ("" === n2)
...
function lc2(t2, e) {
  return t2 instanceof ac2 && e instanceof ac2 ? t2.Yf === e.Yf && t2.S_.isEqual(e.S_) && (null === t2.Zf ? null === e.Zf : t2.Zf.isEqual(e.Zf)) && t2.v_ === e.v_ : t2 instanceof hc2 && e instanceof hc2 && t2.Yf === e.Yf && Ys(t2.query, e.query) && t2.metadata.isEqual(e.metadata) && t2._d.isEqual(e._d);
}
var pc2 = function(t2) {
  function e(e2) {
    var n2 = this;
...
function dc2(t2, e, n2) {
  ...
  return e instanceof Ss && (e = e.d_), yc2(o, [("string" == typeof e || e instanceof As ? ca2(u, "updateDoc", t2.S_, e, n2, r2) : aa2(u, "updateDoc", t2.S_, e)).F_(t2.S_, Re.exists(true))]);
}
function vc2(t2) {
  ...
  "object" != typeof i[s] || La2(i[s]) || (u = i[s], s++);
  var a, c, h2, f = {
    includeMetadataChanges: u.includeMetadataChanges
  };
  if (La2(i[s])) {
    var l = i[s];
    i[s] = null === (e = l.next) || void 0 === e ? void 0 : e.bind(l), i[s + 1] = null === (n2 = l.error) || void 0 === n2 ? void 0 : n2.bind(l), i[s + 2] = null === (r2 = l.complete) || void 0 === r2 ? void 0 : r2.bind(l);
  }
  if (t2 instanceof Fs)
...
var gc2 = function() {
  ...
  return t2.prototype.set = function(t3, e, n2) {
    this.md();
    var r2 = wc2(t3, this.Yf), i = oc2(r2.v_, e, n2), o = ea2(this.Id, "WriteBatch.set", r2.S_, i, null !== r2.v_, n2);
    ...
    return e instanceof Ss && (e = e.d_), o = "string" == typeof e || e instanceof As ? ca2(this.Id, "WriteBatch.update", u.S_, e, n2, r2) : aa2(this.Id, "WriteBatch.update", u.S_, e), this.Ed.push(o.F_(u.S_, Re.exists(true))), this;
  }, t2.prototype.delete = function(t3) {
    this.md();
...
var bc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.get = function(e2) {
    ...
    return t2.prototype.get.call(this, e2).then(function(t3) {
      return new ac2(n2.Yf, i, r2.S_, t3.Zf, new sc2(
        false,
        false
      ), r2.v_);
    });
  ...
  return t2.prototype.get = function(t3) {
    ...
    var r2 = wc2(t3, this.Yf), i = oc2(r2.v_, e, n2), o = ea2(this.Id, "Transaction.set", r2.S_, i, null !== r2.v_, n2);
    return this.Ad.set(r2.S_, o), this;
  }, t2.prototype.update = function(t3, e, n2) {
    for (var r2 = [], i = 3; i < arguments.length; i++)
      r2[i - 3] = arguments[i];
    var o, u = wc2(t3, this.Yf);
    return e instanceof Ss && (e = e.d_), o = "string" == typeof e || e instanceof As ? ca2(this.Id, "Transaction.update", u.S_, e, n2, r2) : aa2(this.Id, "Transaction.update", u.S_, e), this.Ad.update(u.S_, o), this;
  }, t2.prototype.delete = function(t3) {
    var e = wc2(t3, this.Yf);
...
var Tc2 = function() {
  ...
  return t2.prototype.enableIndexedDbPersistence = function(t3, e) {
    return function(t4, e2) {
      ...
      return ja2(n2, i, new bs(i, r2.cacheSizeBytes, null == e2 ? void 0 : e2.forceOwnership));
    }(t3.d_, {
      forceOwnership: e
    });
...
var Nc2 = function(t2) {
  ...
  return __extends(e, t2), Object.defineProperty(e.prototype, "I_", {
    ...
    !function(t4, e3, n2) {
      ...
      "firestore.googleapis.com" !== r2.host && r2.host !== e3 && D2("Host has been set in both settings() and useEmulator(), emulator host will be used"), t4.g_(Object.assign(Object.assign({}, r2), {
        host: e3 + ":" + n2,
        ssl: false
      }));
    }(this.d_, t3, e2);
...
var Sc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.get = function(t3) {
    ...
    for (var r2, i = [], o = 3; o < arguments.length; o++)
      i[o - 3] = arguments[o];
    var u = jc2(t3);
    return 2 === arguments.length ? this.d_.update(u, e2) : (r2 = this.d_).update.apply(r2, __spreadArrays([u, e2, n2], i)), this;
  ...
  return __extends(e, t2), e.pd = function(t3, n2, r2) {
    ...
    try {
      return function(t4, e3, n2) {
        ...
        return yc2(r2, [ea2(ta2(r2), "setDoc", t4.S_, i, null !== t4.v_, n2).F_(t4.S_, Re.Kt())]);
      }(this.d_, t3, e2);
    } catch (t4) {
    ...
    try {
      return 1 === arguments.length ? dc2(this.d_, t3) : dc2.apply(void 0, __spreadArrays([this.d_, t3, e2], n2));
    } catch (t4) {
    ...
    return ("cache" === (null == t3 ? void 0 : t3.source) ? function(t4) {
      ...
      return function(t5, e4) {
        ...
        return new ac2(e3, r2, t4.S_, n3, new sc2(
          n3 instanceof Pt && n3.Vt,
          true
        ), t4.v_);
      });
    }(this.d_) : "server" === (null == t3 ? void 0 : t3.source) ? function(t4) {
      t4 = Ls(t4, Fs);
...
function Cc2(t2, e) {
  ...
  return {
    ...
    error: null === (n2 = (i = La2(t2[0]) ? t2[0] : La2(t2[1]) ? t2[1] : "function" == typeof t2[0] ? {
      next: t2[0],
      error: t2[1],
      complete: t2[2]
    } : {
                  ...
                  return n4 = function(t6, e5, n5) {
                    return __awaiter(this, void 0, void 0, function() {
                      ...
                      return __generator(this, function(a) {
                        switch (a.label) {
                          case 0:
                            return a.trys.push([0, 2, , 3]), [4, ho(
                              t6,
                              e5,
                              true
                            )];
                          case 1:
                            return s = a.sent(), r4 = new Uu(e5, s.Rc), i2 = r4.fl(s.documents), o = r4.wi(
                              i2,
                              false
...
var Fc2 = function(t2) {
  ...
  return __extends(e, t2), Object.defineProperty(e.prototype, "id", {
    ...
    try {
      return new Oc2(this.firestore, void 0 === t3 ? Bs(this.d_) : Bs(this.d_, t3));
    } catch (t4) {
    ...
    return function(t4, e3) {
      ...
      return yc2(n2, [ea2(ta2(t4.firestore), "addDoc", r2.S_, i, null !== t4.v_, {}).F_(r2.S_, Re.exists(false))]).then(function() {
        return r2;
      });
